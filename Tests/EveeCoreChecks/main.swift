...
private func checkOnboardingActionAccessibility() throws {
    ...
    guard actionSource.contains("NativeOnboardingActionButton("),
          ...
          actionSource.contains("isEnabled: store.microphonePermissionGranted,"),
          !actionSource.contains("store.microphonePermissionGranted && store.accessibilityPermissionGranted"),
